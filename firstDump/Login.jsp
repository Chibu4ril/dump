<%-- 
    Document   : Login
    Created on : Oct 14, 2019, 4:31:11 PM
    Author     : Ijen
--%>
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <link rel="stylesheet" type="text/css" href="resourc======es/css/toastr.min.css">
...
<title>Sekani Systems - Login Site</title>
    </head>
...
<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container-fluid">
            <a class="brand" href="/demo/index.php">
                ...
                <img src="/demo/images/logo_small.png" alt="Logo" />
            </a>
            <ul class="nav">
                            </ul>
    ...
    <a class="dropdown-toggle" id="dLabel" role="button" data-toggle="dropdown" data-target="#" href="">
    	<img src="/mlite-frontend/images/icons/flags/en.png" alt="EN" />    </a>
    <span style="max-height: auto;" class="dropdown-menu musoni-pull-right-lang" role="menu" aria-labelledby="dLabel">
        <form action="/demo/index.php/Site/Login" method="post">
          <span id="lang">
            ...
            <label for="lang_0">
              <img src="/mlite-frontend/images/icons/flags/en.png" alt="EN" />
            </label>
            <br />
...
<div id="changePasswordModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="changePasswordModalLabel" aria-hidden="true">
	...
	<div class="form-horizontal" style="width:500px;margin:0px auto;">
		<form id="login-form" action="Login.java" method="post">
      <div class="control-group">
          ...
          <label for="LoginForm_password" class="required">Password <span class="required">*</span></label>
		        ...
		        <div class="controls">
					<input name="password" id="LoginForm_password" type="password" />
